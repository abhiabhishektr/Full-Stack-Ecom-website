    ...
    var n,
        ...
        y = function (t) {
            return (
                ...
                null === t ||
                (g(t) && 0 === t.length) ||
                ("object" === (void 0 === t ? "undefined" : o(t)) && 0 === Object.keys(t).length)
            );
        },
        S = function (t) {
            return !C.isEmpty(t);
    ...
    ((a = t.prototype).axisX = function (t, e, i) {
        ...
        (a.splitTickText = function (t, e, i) {
            ...
            return "[object Array]" === Object.prototype.toString.call(c)
                ? c
                : ((!d || d <= 0) &&
                      (d = s.isVertical() ? 95 : s.params.isCategory ? Math.ceil(i(e[1]) - i(e[0])) - 12 : 110),
                  n(l, c + ""));
        }),
                    ...
                    switch (e.orient) {
                        case "bottom":
                            (a = e.axisX),
                                ...
                                y.attr(
                                    "d",
                                    "M" + e.range[0] + "," + e.outerTickSize + "V0H" + e.range[1] + "V" + e.outerTickSize
                                );
                            break;
                        case "top":
                            (a = e.axisX),
                        ...
                        case "left":
                            (a = e.axisY),
                                ...
                                y.attr(
                                    "d",
                                    "M" + -e.outerTickSize + "," + e.range[0] + "H0V" + e.range[1] + "H" + -e.outerTickSize
                                );
                            break;
                        case "right":
                            (a = e.axisY),
            ...
            return (
                ...
                (t.orient = function (i) {
                    return arguments.length
                        ? ((e.orient = i in { top: 1, right: 1, bottom: 1, left: 1 } ? i + "" : "bottom"), t)
                        : e.orient;
                }),
                ...
                (t.tickInterval = function () {
                    ...
                    return (
                        (i = n.isCategory
                            ? 2 * e.tickOffset
                            : (t.g.select("path.domain").node().getTotalLength() - 2 * e.outerTickSize) /
    ...
    ((n = A.prototype).init = function () {
        ...
        (n.getXAxis = function (t, e, i, n, a, r, o) {
            ...
            return (
                ...
                s.isCategorized() &&
                    (l.tickCentered(c.axis_x_tick_centered), y(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
                l
            );
        }),
        (n.updateXAxisTickValues = function (t, e) {
            ...
            return (
                (a.axis_x_tick_fit || a.axis_x_tick_count) &&
                    (i = this.generateTickValues(n.mapTargetsToUniqueXs(t), a.axis_x_tick_count, n.isTimeSeries())),
        ...
        (n.getYAxis = function (t, e, i, n, a, r, o) {
            ...
            return (
                s.isTimeSeriesY()
                    ? l.ticks(s.d3.time[c.axis_y_tick_time_value], c.axis_y_tick_time_interval)
                    : l.tickValues(n),
                l
            );
        }),
        ...
        (n.getLabelOptionByAxisId = function (t) {
            var e,
                i = this.owner.config;
            return (
                "y" === t ? (e = i.axis_y_label) : "y2" === t ? (e = i.axis_y2_label) : "x" === t && (e = i.axis_x_label), e
            );
        }),
                ...
                : (o.svg &&
                      ...
                      "y" === t
                          ? ((n = o.y.copy().domain(o.getYDomain(i, "y"))),
                            (a = this.getYAxis(n, o.yOrient, s.axis_y_tick_format, o.yAxisTickValues, !1, !0, !0)))
                          : "y2" === t
                          ? ((n = o.y2.copy().domain(o.getYDomain(i, "y2"))),
                            (a = this.getYAxis(n, o.y2Orient, s.axis_y2_tick_format, o.y2AxisTickValues, !1, !0, !0)))
    ...
    return (
        ...
        (C.initWithData = function (t) {
            ...
            (n.axis = new A(n)),
                ...
                n.selectChart.empty() &&
                    ((n.selectChart = a.select(document.createElement("div")).style("opacity", 0)),
        ...
        (C.updateSizes = function () {
            ...
            (t.currentWidth = t.getCurrentWidth()),
                ...
                (t.margin2 = e.axis_rotated
                    ? { top: t.margin.top, right: NaN, bottom: 20 + a, left: t.rotated_padding_left }
                    : { top: t.currentHeight - s - a, right: NaN, bottom: o + a, left: t.margin.left }),
        ...
        (C.redraw = function (t, e) {
            ...
            if (
                ...
                H.length
                    ? (I.updateXDomain(H, d, l, u), D.axis_x_tick_values || (C = I.axis.updateXAxisTickValues(H)))
                ...
                !D.axis_y_tick_values &&
                    D.axis_y_tick_count &&
                    I.yAxis.tickValues(I.axis.generateTickValues(I.y.domain(), D.axis_y_tick_count)),
                !D.axis_y2_tick_values &&
                    D.axis_y2_tick_count &&
                    I.y2Axis.tickValues(I.axis.generateTickValues(I.y2.domain(), D.axis_y2_tick_count)),
                I.axis.redraw(e, z),
        ...
        (C.xv = function (t) {
            ...
            return (
                e.isTimeSeries()
                    ...
                    : e.isCategorized() && "string" == typeof t.value && (i = e.config.axis_x_categories.indexOf(t.value)),
                Math.ceil(e.x(i))
            );
        }),
        (C.yv = function (t) {
                ...
                (n.prototype._isCurrentSpace = function () {
                    ...
                    (n.prototype._parseNumber = function () {
                        ...
                        if (
                            ...
                            var l = e + n;
                            if (((l *= a), t && (l *= Math.pow(10, r * t)), o != this._currentIndex))
                    ...
                    (n.prototype.parseSegment = function () {
                        ...
                        if (i == window.SVGPathSeg.PATHSEG_UNKNOWN) {
                            ...
                            if (
                                (i = this._nextCommandHelper(t, this._previousCommand)) == window.SVGPathSeg.PATHSEG_UNKNOWN
                            )
                                return null;
        ...
        (P.axis.max = function (t) {
            ...
            "object" === (void 0 === t ? "undefined" : o(t))
                ? (l(t.x) && (i.axis_x_max = t.x), l(t.y) && (i.axis_y_max = t.y), l(t.y2) && (i.axis_y2_max = t.y2))
        ...
        (P.axis.min = function (t) {
            ...
            "object" === (void 0 === t ? "undefined" : o(t))
                ? (l(t.x) && (i.axis_x_min = t.x), l(t.y) && (i.axis_y_min = t.y), l(t.y2) && (i.axis_y2_min = t.y2))
            ...
            (e = c.convertDataToTargets(i, !0)),
                c.data.targets.forEach(function (t) {
                    ...
                    for (i = 0; i < e.length; i++)
                        if (t.id === e[i].id) {
                            for (
                                a = !0,
                                    t.values[t.values.length - 1] && (g = t.values[t.values.length - 1].index + 1),
                                    h = e[i].values.length,
                                    n = 0;
                                n < h;
                                n++
                ...
                c.data.targets.forEach(function (t) {
                    ...
                    for (e = 0; e < d.length; e++)
                        if (t.id === d[e])
                            for (g = t.values[t.values.length - 1].index + 1, i = 0; i < h; i++)
                                t.values.push({
                                    id: t.id,
                                    index: g + i,
                ...
                n.main
                    ...
                    .each(function (s, c) {
                        ...
                        d.classed(r.line) ||
                            d.classed(r.area) ||
                            (h && g
                                ? o.data_selection_isselectable(s) && !f && u(!0, d.classed(r.SELECTED, !0), s, c)
                                : void 0 !== i && i && f && u(!1, d.classed(r.SELECTED, !1), s, c));
                    });
        }),
            ...
            a.data_selection_enabled &&
                i.main
                    ...
                    .each(function (o, s) {
                        ...
                        c.classed(r.line) ||
                            c.classed(r.area) ||
                            (u && h && a.data_selection_isselectable(o) && g && l(!1, c.classed(r.SELECTED, !1), o, s));
                    });
        }),
        (P.show = function (t, e) {
            var i,
        ...
        (P.xs = function (t) {
            ...
            return (
                arguments.length &&
                    (e.updateTargetXs(e.data.targets, t), e.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 })),
                e.data.xs
            );
        }),
        (P.zoom = function (t) {
            ...
            return o.shouldShowArcLabel()
                ? ((e = o.updateAngle(t)),
                  ...
                  o.hasType("gauge") || o.meetsArcLabelThreshold(n)
                      ? ((r = o.getArcLabelFormat()), r ? r(i, n, a) : o.defaultArcValueFormat(i, n))
                      : "")
                : "";
        }),
            ...
            i.transiting
                ? (e = window.setInterval(function () {
                      i.transiting ||
                          ...
                          i.legend.selectAll(".c3-legend-item-focused").size() > 0 && i.expandArc(t));
                  }, 10))
                : ((t = i.mapToTargetIds(t)),
        ...
        (C.getClipPath = function (t) {
            return (
                "url(" +
                (window.navigator.appVersion.toLowerCase().indexOf("msie 9.") >= 0 ? "" : document.URL.split("#")[0]) +
                "#" +
                t +
                ")"
            );
            ...
            return function (t) {
                ...
                return (
                    n[i] instanceof Function
                        ...
                        : n[i]
                        ? (e = n[i])
                        : (o.indexOf(i) < 0 && o.push(i), (e = a[o.indexOf(i) % a.length]), (n[i] = e)),
        ...
        (C.loadConfig = function (t) {
            function e() {
                var t = n.shift();
                return t && i && "object" === (void 0 === i ? "undefined" : o(i)) && t in i
                    ? ((i = i[t]), e())
                    : t
                    ? void 0
                    : i;
            ...
            for (var e = [], i = 0; i < t.length; i++)
                for (var n = t[i][0], a = 1; a < t[i].length; a++) {
                    if ((void 0 === e[a - 1] && (e[a - 1] = {}), void 0 === t[i][a]))
                        throw new Error("Source data is missing a component at (" + i + "," + a + ")!");
                    e[a - 1][n] = t[i][a];
                }
            return e;
        }),
                                    ...
                                    n.isCustomX() && n.isCategorized() && void 0 !== c
                                        ? (0 === i && 0 === o && (a.axis_x_categories = []),
                                          -1 === (s = a.axis_x_categories.indexOf(c)) &&
                                              ((s = a.axis_x_categories.length), a.axis_x_categories.push(c)))
        ...
        (C.findClosest = function (t, e) {
            ...
            return (
                t
                    ...
                    .forEach(function (t) {
                        var e = n.main
                            .select("." + r.bars + n.getTargetSelectorSuffix(t.id) + " ." + r.bar + "-" + t.index)
                            .node();
        ...
        (C.getXDomain = function (t) {
            ...
            return (
                n - a != 0 ||
                    e.isCategorized() ||
                    (e.isTimeSeries()
                        ? ((n = new Date(0.5 * n.getTime())), (a = new Date(1.5 * a.getTime())))
        ...
        (C.updateXDomain = function (t, e, i, n, a) {
            ...
            return (
                ...
                e &&
                    (r.x.domain(a || (!r.brush || r.brush.empty() ? r.orgXDomain : r.brush.extent())),
                    o.zoom_enabled && r.zoom.scale(r.x).updateScaleExtent()),
        ...
        (C.initGrid = function () {
            ...
            (t.grid = t.main.append("g").attr("clip-path", t.clipPathForGrid).attr("class", r.grid)),
                ...
                e.grid_focus_show &&
                    t.grid.append("g").attr("class", r.xgridFocus).append("line").attr("class", r.xgridFocus),
                (t.xgrid = i.selectAll([])),
        ...
        (C.generateGridData = function (t, e) {
            var i,
                ...
                d = s.main
                    ...
                    .size();
            if ("year" === t)
                for (n = (i = s.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), o = n; o <= a; o++)
                    ...
                    : ((!s.isCustomX() && !s.isTimeSeries()) || s.isCategorized()
                          ...
                          : (s.updateXs(),
                            ...
                            (o = function (t) {
                                ...
                                return null === e && null === i
                                    ? 0
                                    : (null === e && (e = s.x.domain()[0]), (s.x(n) + s.x(e)) / 2);
                            })),
                    ...
                    e.dragging ||
                        ...
                        (!n.tooltip_grouped || (n.data_selection_enabled && !n.data_selection_grouped)) &&
                            e.main
                                ...
                                .each(function () {
                                    i.select(this).classed(r.EXPANDED, !0),
                                        n.data_selection_enabled &&
                                            s.style("cursor", n.data_selection_grouped ? "pointer" : null),
                                        n.tooltip_grouped ||
                                            (e.hideXGridFocus(),
                                            e.hideTooltip(),
                                            n.data_selection_grouped || (e.unexpandCircles(o), e.unexpandBars(o)));
                                })
                                .filter(function (t) {
                                ...
                                .each(function (t) {
                                    n.data_selection_enabled &&
                                        (n.data_selection_grouped || n.data_selection_isselectable(t)) &&
                                        s.style("cursor", "pointer"),
                                        n.tooltip_grouped ||
                                            (e.showTooltip([t], this),
                                            e.showXGridFocus([t]),
                                            n.point_focus_expand_enabled && e.expandCircles(o, t.id, !0),
                            ...
                            : (e.isStepType(t) &&
                              ...
                              e.main.selectAll("." + r.shape + "-" + a).each(function (t) {
                                  (n.data_selection_grouped || e.isWithinShape(this, t)) &&
                                      (e.toggleShape(this, t, a), e.config.data_onclick.call(e.api, t, this));
                              })));
                })
                .call(
                ...
                .on("mousemove", function () {
                    ...
                    i.dragging ||
                        ...
                        !i.mouseover ||
                            ...
                            (a.data_onmouseout.call(i.api, i.mouseover), (i.mouseover = void 0)),
                        o
                            ? ((s = (i.isScatterType(o) || !a.tooltip_grouped ? [o] : i.filterByX(c, o.x)).map(function (
                                  t
                              ) {
                                  return i.addName(t);
                              })),
                              ...
                              (i.isBarType(o.id) || i.dist(o, t) < a.point_sensitivity) &&
                                  ...
                                  i.mouseover || (a.data_onmouseover.call(i.api, o), (i.mouseover = o))))
                            : e());
                })
                .on("click", function () {
                    var t,
                            ...
                            i.main
                                ...
                                .each(function () {
                                    (a.data_selection_grouped || i.isWithinShape(this, e)) &&
                                        (i.toggleShape(this, e, e.index), i.config.data_onclick.call(i.api, e, this));
                                }));
                })
                .call(
        ...
        (C.hideLegend = function (t) {
            var e = this,
                i = e.config;
            i.legend_show && y(t) && ((i.legend_show = !1), e.legend.style("visibility", "hidden")),
        ...
        (C.updateLegend = function (t, e, i) {
            function n(t, e) {
                return (
                    b.legendItemTextBox[e] || (b.legendItemTextBox[e] = b.getTextRect(t.textContent, r.legendItem, t)),
                ...
                (p = b.legend
                    ...
                    .on("click", function (t) {
                        T.legend_item_onclick
                            ...
                            : (b.api.toggle(t), b.isTargetToShow(t) ? b.api.focus(t) : b.api.revert());
                    })
                    .on("mouseover", function (t) {
                    ...
                    .on("mouseout", function (t) {
                        T.legend_item_onmouseout
                            ...
                            : (b.d3.select(this).classed(r.legendItemFocused, !1), b.api.revert());
                    }))
                    .append("text")
                    .text(function (t) {
        ...
        (C.getBars = function (t, e) {
            var i = this;
            return (e ? i.main.selectAll("." + r.bars + i.getTargetSelectorSuffix(e)) : i.main).selectAll(
                "." + r.bar + (l(t) ? "-" + t : "")
            );
        }),
            ...
            if (void 0 !== n)
                for (r = 0; r < n.length; r++)
                    (S[r] = {}),
                        void 0 === n[r].start
                            ? (S[r].start = t[0].x)
                            : (S[r].start = _.isTimeSeries() ? _.parseDate(n[r].start) : n[r].start),
                        void 0 === n[r].end
                            ? (S[r].end = t[t.length - 1].x)
                            : (S[r].end = _.isTimeSeries() ? _.parseDate(n[r].end) : n[r].end);
            for (
                f = x.axis_rotated
                    ? function (t) {
                          return i(t.value);
                ...
                function (t) {
                    ...
                    return (
                        i.isAreaType(t)
                            ...
                            : (r[0] && ((o = i.x(r[0].x)), (s = i.getYScale(t.id)(r[0].value))),
        ...
        (C.redrawCircle = function (t, e, i) {
            ...
            return [
                (i ? this.mainCircle.transition(Math.random().toString()) : this.mainCircle)
        ...
        (C.getCircles = function (t, e) {
            var i = this;
            return (e ? i.main.selectAll("." + r.circles + i.getTargetSelectorSuffix(e)) : i.main).selectAll(
                "." + r.circle + (l(t) ? "-" + t : "")
            );
        }),
                ...
                ? "x" === t && i.axis_x_height
                    ...
                    ? "y2" !== t || i.axis_y2_show
                        ? ("x" === t &&
                              ...
                              (n =
                                  30 + e.axis.getMaxTickWidth(t) * Math.cos((Math.PI * (90 - i.axis_x_tick_rotate)) / 180)),
                          "y" === t &&
                              i.axis_rotated &&
                              i.axis_y_tick_rotate &&
                              (n =
                                  30 + e.axis.getMaxTickWidth(t) * Math.cos((Math.PI * (90 - i.axis_y_tick_rotate)) / 180)),
        ...
        (C.transformContext = function (t, e) {
            var i,
                n = this;
            e && e.axisSubX ? (i = e.axisSubX) : ((i = n.context.select("." + r.axisX)), t && (i = i.transition())),
        ...
        (C.getXForText = function (t, e, i) {
            ...
            return (
                r.config.axis_rotated
                    ? ((a = r.isBarType(e) ? 4 : 6), (n = t[2][1] + a * (e.value < 0 ? -1 : 1)))
                ...
                a.config.axis_rotated
                    ...
                    : ((n = t[2][1]),
                      e.value < 0 || (0 === e.value && !a.hasPositiveValue)
                          ? ((n += r.height),
                            a.isBarType(e) && a.isSafari() ? (n -= 3) : !a.isBarType(e) && a.isChrome() && (n += 3))
                          : (n += a.isBarType(e) ? -3 : -6)),
                null !== e.value ||
                    a.config.axis_rotated ||
                    (n < r.height ? (n = r.height) : n > this.height && (n = this.height - 4)),
                n
            );
        }),
        ...
        (C.yForTitle = function () {
            var t = this;
            return (
                t.config.title_padding.top + t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).height
            );
        }),
        ...
        (C.tooltipPosition = function (t, e, i, n) {
            ...
            return (
                h
                    ? ((r = (d.width - (d.isLegendRight ? d.getLegendWidth() : 0)) / 2 + g[0]),
                      (s = d.height / 2 + g[1] + 20))
                    : ((a = d.getSvgLeft(!0)),
                      l.axis_rotated
                          ? ((o = (r = a + g[0] + 100) + e),
                            ...
                            (s = d.x(t[0].x) + 20))
                          : ((o = (r = a + d.getCurrentPaddingLeft(!0) + d.x(t[0].x) + 20) + e),
        ...
        (C.showTooltip = function (t, e) {
            ...
            0 !== c.length &&
                o.tooltip_show &&
                (r.tooltip
                    .html(o.tooltip_contents.call(r, t, r.axis.getXAxisTickFormat(), r.getYFormat(s), r.color))
                    .style("display", "block"),
        ...
        (C.isLineType = function (t) {
            ...
            return (
                !e.data_types[i] ||
                ["line", "spline", "area", "area-spline", "step", "area-step"].indexOf(e.data_types[i]) >= 0
            );
        }),
            ...
            (e.zoom = i.behavior
                ...
                .on("zoomstart", function () {
                    (t = i.event.sourceEvent),
                        (e.zoom.altDomain = i.event.sourceEvent.altKey ? e.x.orgDomain() : null),
                ...
                .on("zoomend", function () {
                    ...
                    (a && t.clientX === a.clientX && t.clientY === a.clientY) ||
                        (e.redrawEventRect(), e.updateZoom(), n.zoom_onzoomend.call(e.api, e.x.orgDomain()));
                })),
